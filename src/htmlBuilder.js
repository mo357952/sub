...
const generateHead = () => `
  <head>
    ...
    <meta name="description" content="Sublink链接转换工具">
    <meta name="keywords" content="Sublink">
    <title>Sublink转换工具</title>
    <meta property="og:title" content="Sublink链接转换工具">
    <meta property="og:description" content="链接转换工具">
...
const generateCardHeader = () => `
  <div class="card-header text-center">
    <h1 class="display-4 mb-0">Sublink链接转换工具</h1>
  </div>
`;
